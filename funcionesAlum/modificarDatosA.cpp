...
void Menu::modificarDatosA(int auxcodigo)
{
  ...
  ptr_alumns[auxcodigo-1].setDatosPer(auxnombres, auxapellidos,auxdni,auxcelular,auxdireccion,auxestdCiv);
